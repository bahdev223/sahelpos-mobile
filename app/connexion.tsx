...
const styles = StyleSheet.create({
  ...
  nomBoutique: { fontSize: 26, fontWeight: '800', color: couleurs.texte },
  consigne: {
    fontSize: 15,
  ...
  compteUniqueNom: { fontSize: 18, fontWeight: '700', color: couleurs.texte },
  pastilles: {
    flexDirection: 'row',
    justifyContent: 'center',
    gap: espaces.m,
  ...
  toucheTexte: { fontSize: 28, fontWeight: '700', color: couleurs.texte },
